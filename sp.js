...
var s = {
    ...
    user: {
        search: function (keyword) {
            return s.auth()
                .then(function (response) {
                    return fetch(s.url + "/_api/search/query?querytext='" + keyword + "'&selectproperties='UserName,Title,JobTitle,WorkPhone'&sourceid='b09a7990-05ea-4af9-81ef-edfab16c4e31'&clienttype='PeopleResultsQuery'", {
    ...
    search: function (keyword, selectproperties) {
        return s.auth()
            .then(function (response) {
                var apiUrl = s.url + "/_api/search/query?querytext='" + keyword + "'";
                if (selectproperties) {
    ...
    list: {
        ...
        get: function (listTitle) {
            return s.auth()
                .then(function (response) {
                    return fetch(s.url + "/_api/web/lists/GetByTitle('" + listTitle + "')", {
                        headers: s.def.headers(response)
                    });
                })
                .then(s.def.json)
        ...
        getFields: function (listTitle) {
            return s.auth()
                .then(function (response) {
                    return fetch(s.url + "/_api/web/lists/GetByTitle('" + listTitle + "')/fields", {
                        headers: s.def.headers(response)
                    });
                })
                .then(s.def.json)
        ...
        setTitle: function (listCurrentTitle, listNewTitle) {
            return s.auth()
                .then(function (response) {
                    return fetch(s.url + "/_api/web/lists/GetByTitle('" + listCurrentTitle + "')", {
                        headers: s.def.headers(response, true),
                        method: "POST",
                        body: JSON.stringify({
                            "Title": listNewTitle
    ...
    view: {
        all: function (listTitle) {
            return s.auth()
                .then(function (response) {
                    return fetch(s.url + "/_api/lists/getByTitle('" + listTitle + "')/views", {
                        headers: s.def.headers(response)
                    });
                })
                .then(s.def.json)
        ...
        get: function (listTitle, viewTitle) {
            return s.auth()
                .then(function (response) {
                    return fetch(s.url + "/_api/web/lists/GetByTitle('" + listTitle + "')/views/GetByTitle('" + viewTitle + "')", {
                        headers: s.def.headers(response)
                    });
                })
                .then(s.def.json)
